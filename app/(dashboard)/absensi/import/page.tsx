...
const IconAlertCircle   = ({ size = 16 }: { size?: number }) => <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
const IconFile          = ({ size = 40 }: { size?: number }) => <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
const IconArrow         = () => <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
    ...
    <div className="max-w-4xl mx-auto">
        ...
        {(['upload', 'preview', 'done'] as Phase[]).map((p, i) => {
          ...
          return (
            <div key={p} className="flex items-center gap-2">
              ...
              {i < 2 && <span className="text-slate-300 ml-1"><IconArrow /></span>}
            </div>
          )
        })}
      </div>
      ...
      {phase === 'upload' && (
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
          ...
          >
            <div className="mx-auto mb-3 text-slate-400 flex justify-center"><IconFile size={40} /></div>
          ...
          {parseResult.employees.filter(e => e.status === 'matched').length > 0 && (
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
              <div className="px-5 py-3 bg-green-50 border-b border-green-100 flex items-center gap-2">
                <span className="text-green-600"><IconCheckCircle size={15} /></span>
          ...
          {parseResult.employees.filter(e => e.status === 'not_found').length > 0 && (
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
              <div className="px-5 py-3 bg-orange-50 border-b border-orange-100 flex items-center gap-2">
                <span className="text-orange-600"><IconAlertCircle size={15} /></span>
      ...
      {phase === 'done' && doneResult && (
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-8 text-center">
          <div className="flex justify-center mb-4 text-green-500"><IconCheckCircle size={48} /></div>
