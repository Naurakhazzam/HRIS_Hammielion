...
export default function PembelianSupplierPage({ defaultTab }: { defaultTab: 'input' | 'ringkasan-supplier' }) {
  ...
  // Tab awal ditentukan oleh rute yang dipakai untuk masuk ke halaman ini — /keuangan/pembelian
  // (menu Laporan Keuangan → Ringkasan Supplier) vs /keuangan/pembelian/input (menu Keuangan →
  // Pembelian & Utang Supplier). Satu komponen, dua pintu masuk, supaya tidak ada logika dobel.
  const [activeTab, setActiveTab] = useState<'input' | 'ringkasan-supplier'>(defaultTab)
